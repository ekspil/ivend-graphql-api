...
class ControllerDTO {
    ...
    constructor({id, name, uid, revision, status, mode, readStatMode, bankTerminalMode, fiscalizationMode, accessKey, lastState, firmwareId, registrationTime, connected, remotePrinterId, simCardNumber, imsi, cashless}) {
        this.id = id
        this.name = name
        this.uid = uid
