...
class FiscalReceiptDTO {
    ...
    constructor({id, email, sno, inn, place, itemName, itemPrice, paymentType, fiscalData, status, createdAt, kktRegNumber, itemType, controllerUid, kktProvider, kkt_provider, rekassa_kkt_id, rekassa_number, rekassa_password}) {
        this.id = id
        this.email = email
        this.sno = sno
        this.inn = inn
        ...
        this.kktProvider = kktProvider || kkt_provider
